    ...
    <table width="990px">
            ...
            <td>
                ...
                <select name="danh_muc" style="margin-top:3px;margin-bottom:3px;">
                    ...
                    while ($tv_2 = mysqli_fetch_array($tv_1)) {
                        $ten = $tv_2['ten'];
                        $id_menu = $tv_2['id'];
                        $a = ($_SESSION['danh_muc_menu'] == $id_menu) ? "selected" : "";
        ...
        <tr>
            ...
            <td>
                ...
                $a_1 = "";
                $a_2 = "";
                if (isset($_SESSION['tuy_chon_trang_chu']) && $_SESSION['tuy_chon_trang_chu'] == "co") {
                    $a_2 = "selected";
                }
                ?>
        ...
        <tr>
            ...
            <td>
                ...
                $a_1 = "";
                $a_2 = "";
                if (isset($_SESSION['tuy_chon_noi_bat']) && $_SESSION['tuy_chon_noi_bat'] == "co") {
                    $a_2 = "selected";
                }
                ?>
