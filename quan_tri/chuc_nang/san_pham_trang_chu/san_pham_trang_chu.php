...
<form method="post" >
	<table width="990px" class="tb_a1" >
		<tr style="background:#000000;height:40px;" >
			<td style="color:white;" width="120px" ><b>Hình ảnh</b></td>
			<td style="color:white;" width="450px" ><b>Tên</b></td>
			<td style="color:white;" align="center" width="140px" ><b>Giá</b></td>
			<td style="color:white;" align="center" width="140px" ><b>Trang chủ</b></td>
			<td style="color:white;" align="center" width="140px" ><b>Thứ tự</b></td>		
		</tr>
		<?php 
			$i=1;
